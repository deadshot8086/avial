...
void ecc(       fp timeinst,
                                const fp initvalu[EQUATIONS],
                                int initvalu_offset,
                                const fp parameter[PARAMETERS],
                                int parameter_offset,
                                fp finavalu[13 * EQUATIONS], int finavalu_offset){
	...
	finavalu[finavalu_offset + offset_1] = am*(1-initvalu_1)-bm*initvalu_1;
	finavalu[finavalu_offset + offset_2] = ah*(1-initvalu_2)-bh*initvalu_2;
	finavalu[finavalu_offset + offset_3] = aj*(1-initvalu_3)-bj*initvalu_3;
	...
	finavalu[finavalu_offset + offset_12] = (xrss-initvalu_12)/tauxr;
	...
	finavalu[finavalu_offset + offset_13] = (xsss-initvalu_13)/tauxs;
	...
	finavalu[finavalu_offset + offset_8] = (xtoss-initvalu_8)/tauxtos;
	finavalu[finavalu_offset + offset_9] = (ytoss-initvalu_9)/tauytos;
	finavalu[finavalu_offset + offset_40]= (rtoss-initvalu_40)/taurtos; 
	...
	finavalu[finavalu_offset + offset_10] = (xtoss-initvalu_10)/tauxtof;
	finavalu[finavalu_offset + offset_11] = (ytoss-initvalu_11)/tauytof;
	...
	finavalu[finavalu_offset + offset_4] = (dss-initvalu_4)/taud;
	finavalu[finavalu_offset + offset_5] = (fss-initvalu_5)/tauf;
	finavalu[finavalu_offset + offset_6] = 1.7*initvalu_36*(1-initvalu_6)-11.9e-3*initvalu_6;											// fCa_junc  
	finavalu[finavalu_offset + offset_7] = 1.7*initvalu_37*(1-initvalu_7)-11.9e-3*initvalu_7;											// fCa_sl
	...
	finavalu[finavalu_offset + offset_43]=-I_Ca*Cmem/(Vmyo*2*Frdy)*1e3;
	...
	finavalu[finavalu_offset + offset_45]=2*I_ncx*Cmem/(Vmyo*2*Frdy)*1e3;
	...
	finavalu[finavalu_offset + offset_44]=-I_pca*Cmem/(Vmyo*2*Frdy)*1e3;

	// I_cabk: Ca Background Current
	I_cabk_junc = Fjunc*GCaB*(initvalu_39-eca_junc);
	I_cabk_sl = Fsl*GCaB*(initvalu_39-eca_sl);
	I_cabk = I_cabk_junc+I_cabk_sl;
	finavalu[finavalu_offset + offset_46]=-I_cabk*Cmem/(Vmyo*2*Frdy)*1e3;
	...
	finavalu[finavalu_offset + offset_14] = (kim*RI-kiSRCa*initvalu_36*initvalu_14)-(koSRCa*pow(initvalu_36,2)*initvalu_14-kom*initvalu_15);			// R
	finavalu[finavalu_offset + offset_15] = (koSRCa*pow(initvalu_36,2)*initvalu_14-kom*initvalu_15)-(kiSRCa*initvalu_36*initvalu_15-kim*initvalu_16);			// O
	finavalu[finavalu_offset + offset_16] = (kiSRCa*initvalu_36*initvalu_15-kim*initvalu_16)-(kom*initvalu_16-koSRCa*pow(initvalu_36,2)*RI);			// I
	...
	finavalu[finavalu_offset + offset_17] = kon_na*initvalu_32*(Bmax_Naj-initvalu_17)-koff_na*initvalu_17;								// NaBj      [mM/ms]
	finavalu[finavalu_offset + offset_18] = kon_na*initvalu_33*(Bmax_Nasl-initvalu_18)-koff_na*initvalu_18;							// NaBsl     [mM/ms]

	// Cytosolic Ca Buffers
	finavalu[finavalu_offset + offset_19] = kon_tncl*initvalu_38*(Bmax_TnClow-initvalu_19)-koff_tncl*initvalu_19;						// TnCL      [mM/ms]
	finavalu[finavalu_offset + offset_20] = kon_tnchca*initvalu_38*(Bmax_TnChigh-initvalu_20-initvalu_21)-koff_tnchca*initvalu_20;			// TnCHc     [mM/ms]
	finavalu[finavalu_offset + offset_21] = kon_tnchmg*Mgi*(Bmax_TnChigh-initvalu_20-initvalu_21)-koff_tnchmg*initvalu_21;				// TnCHm     [mM/ms]
	finavalu[finavalu_offset + offset_22] = 0;																		// CaM       [mM/ms]
	finavalu[finavalu_offset + offset_23] = kon_myoca*initvalu_38*(Bmax_myosin-initvalu_23-initvalu_24)-koff_myoca*initvalu_23;				// Myosin_ca [mM/ms]
	finavalu[finavalu_offset + offset_24] = kon_myomg*Mgi*(Bmax_myosin-initvalu_23-initvalu_24)-koff_myomg*initvalu_24;				// Myosin_mg [mM/ms]
	finavalu[finavalu_offset + offset_25] = kon_sr*initvalu_38*(Bmax_SR-initvalu_25)-koff_sr*initvalu_25;								// SRB       [mM/ms]
	J_CaB_cytosol = finavalu[finavalu_offset + offset_19] + finavalu[finavalu_offset + offset_20] + finavalu[finavalu_offset + offset_21] + finavalu[finavalu_offset + offset_22] + finavalu[finavalu_offset + offset_23] + finavalu[finavalu_offset + offset_24] + finavalu[finavalu_offset + offset_25];

	// Junctional and SL Ca Buffers
	finavalu[finavalu_offset + offset_26] = kon_sll*initvalu_36*(Bmax_SLlowj-initvalu_26)-koff_sll*initvalu_26;						// SLLj      [mM/ms]
	finavalu[finavalu_offset + offset_27] = kon_sll*initvalu_37*(Bmax_SLlowsl-initvalu_27)-koff_sll*initvalu_27;						// SLLsl     [mM/ms]
	finavalu[finavalu_offset + offset_28] = kon_slh*initvalu_36*(Bmax_SLhighj-initvalu_28)-koff_slh*initvalu_28;						// SLHj      [mM/ms]
	finavalu[finavalu_offset + offset_29] = kon_slh*initvalu_37*(Bmax_SLhighsl-initvalu_29)-koff_slh*initvalu_29;						// SLHsl     [mM/ms]
	J_CaB_junction = finavalu[finavalu_offset + offset_26]+finavalu[finavalu_offset + offset_28];
	J_CaB_sl = finavalu[finavalu_offset + offset_27]+finavalu[finavalu_offset + offset_29];

	// SR Ca Concentrations
	finavalu[finavalu_offset + offset_30] = kon_csqn*initvalu_31*(Bmax_Csqn-initvalu_30)-koff_csqn*initvalu_30;						// Csqn      [mM/ms]
	oneovervsr = 1/Vsr;
	finavalu[finavalu_offset + offset_31] = J_serca*Vmyo*oneovervsr-(J_SRleak*Vmyo*oneovervsr+J_SRCarel)-finavalu[finavalu_offset + offset_30];   // Ca_sr     [mM/ms] %Ratio 3 leak current
	...
	finavalu[finavalu_offset + offset_32] = -I_Na_tot_junc*Cmem/(Vjunc*Frdy)+J_na_juncsl/Vjunc*(initvalu_33-initvalu_32)-finavalu[finavalu_offset + offset_17];
	oneovervsl = 1/Vsl;
	finavalu[finavalu_offset + offset_33] = -I_Na_tot_sl*Cmem*oneovervsl/Frdy+J_na_juncsl*oneovervsl*(initvalu_32-initvalu_33)+J_na_slmyo*oneovervsl*(initvalu_34-initvalu_33)-finavalu[finavalu_offset + offset_18];
	finavalu[finavalu_offset + offset_34] = J_na_slmyo/Vmyo*(initvalu_33-initvalu_34);											// [mM/msec] 

	// Potassium Concentration
	I_K_tot = I_to+I_kr+I_ks+I_ki-2*I_nak+I_CaK+I_kp;									// [uA/uF]
	finavalu[finavalu_offset + offset_35] = 0;															// [mM/msec]

	// Calcium Concentrations
	I_Ca_tot_junc = I_Ca_junc+I_cabk_junc+I_pca_junc-2*I_ncx_junc;						// [uA/uF]
	I_Ca_tot_sl = I_Ca_sl+I_cabk_sl+I_pca_sl-2*I_ncx_sl;								// [uA/uF]
	finavalu[finavalu_offset + offset_36] = -I_Ca_tot_junc*Cmem/(Vjunc*2*Frdy)+J_ca_juncsl/Vjunc*(initvalu_37-initvalu_36)
	         - J_CaB_junction+(J_SRCarel)*Vsr/Vjunc+J_SRleak*Vmyo/Vjunc;				// Ca_j
	finavalu[finavalu_offset + offset_37] = -I_Ca_tot_sl*Cmem/(Vsl*2*Frdy)+J_ca_juncsl/Vsl*(initvalu_36-initvalu_37)
	         + J_ca_slmyo/Vsl*(initvalu_38-initvalu_37)-J_CaB_sl;									// Ca_sl
	finavalu[finavalu_offset + offset_38] = -J_serca-J_CaB_cytosol +J_ca_slmyo/Vmyo*(initvalu_37-initvalu_38);
	...
	finavalu[finavalu_offset + offset_39] = -(I_tot-I_app);

	// Set unused output values to 0 (MATLAB does it by default)
	finavalu[finavalu_offset + offset_41] = 0;
	finavalu[finavalu_offset + offset_42] = 0;
