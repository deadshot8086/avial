...
//	MAIN FUNCTION
//=====================================================================
void fin(       const fp initvalu[EQUATIONS],
...
//=====================================================================
	...
	finavalu[finavalu_offset + initvalu_offset_ecc+35] = finavalu[finavalu_offset + initvalu_offset_ecc+35] + 1e-3*JCaDyad;
	finavalu[finavalu_offset + initvalu_offset_ecc+36] = finavalu[finavalu_offset + initvalu_offset_ecc+36] + 1e-3*JCaSL;
	finavalu[finavalu_offset + initvalu_offset_ecc+37] = finavalu[finavalu_offset + initvalu_offset_ecc+37] + 1e-3*JCaCyt; 
	...
	// ADJUST CAM Dyad 
	finavalu[finavalu_offset + initvalu_offset_Dyad+0] = finavalu[finavalu_offset + initvalu_offset_Dyad+0] - J_cam_dyadSL;
	finavalu[finavalu_offset + initvalu_offset_Dyad+1] = finavalu[finavalu_offset + initvalu_offset_Dyad+1] - J_ca2cam_dyadSL;
	finavalu[finavalu_offset + initvalu_offset_Dyad+2] = finavalu[finavalu_offset + initvalu_offset_Dyad+2] - J_ca4cam_dyadSL;
	
	// ADJUST CAM Sl
	finavalu[finavalu_offset + initvalu_offset_SL+0] = finavalu[finavalu_offset + initvalu_offset_SL+0] + J_cam_dyadSL*Vdyad/VSL - J_cam_SLmyo/VSL;
	finavalu[finavalu_offset + initvalu_offset_SL+1] = finavalu[finavalu_offset + initvalu_offset_SL+1] + J_ca2cam_dyadSL*Vdyad/VSL - J_ca2cam_SLmyo/VSL;
	finavalu[finavalu_offset + initvalu_offset_SL+2] = finavalu[finavalu_offset + initvalu_offset_SL+2] + J_ca4cam_dyadSL*Vdyad/VSL - J_ca4cam_SLmyo/VSL;

	// ADJUST CAM Cyt 
	finavalu[finavalu_offset + initvalu_offset_Cyt+0] = finavalu[finavalu_offset + initvalu_offset_Cyt+0] + J_cam_SLmyo/Vmyo;
	finavalu[finavalu_offset + initvalu_offset_Cyt+1] = finavalu[finavalu_offset + initvalu_offset_Cyt+1] + J_ca2cam_SLmyo/Vmyo;
	finavalu[finavalu_offset + initvalu_offset_Cyt+2] = finavalu[finavalu_offset + initvalu_offset_Cyt+2] + J_ca4cam_SLmyo/Vmyo;
