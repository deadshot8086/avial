...
fp cam(fp timeinst,
	...
	// encode output array
	finavalu[finavalu_offset + offset_1] = dCaM;
	finavalu[finavalu_offset + offset_2] = dCa2CaM;
	finavalu[finavalu_offset + offset_3] = dCa4CaM;
	finavalu[finavalu_offset + offset_4] = dCaMB;
	finavalu[finavalu_offset + offset_5] = dCa2CaMB;
	finavalu[finavalu_offset + offset_6] = dCa4CaMB;
	finavalu[finavalu_offset + offset_7] = dPb2;
	finavalu[finavalu_offset + offset_8] = dPb;
	finavalu[finavalu_offset + offset_9] = dPt;
	finavalu[finavalu_offset + offset_10] = dPt2;
	finavalu[finavalu_offset + offset_11] = dPa;
	finavalu[finavalu_offset + offset_12] = dCa4CaN;
	finavalu[finavalu_offset + offset_13] = dCaMCa4CaN;
	finavalu[finavalu_offset + offset_14] = dCa2CaMCa4CaN;
	finavalu[finavalu_offset + offset_15] = dCa4CaMCa4CaN;
