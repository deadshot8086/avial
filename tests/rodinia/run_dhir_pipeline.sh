...
OUT_DIR="$PWD/tests/rodinia/test_output"
mkdir -p "$OUT_DIR"

echo "=========================================================================================="
echo "Running DHIR Compiler Pipeline (from tests/run_tests.sh) on Rodinia MLIR files"
...
for f in $PWD/tests/rodinia/*.mlir; do
