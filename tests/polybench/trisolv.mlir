...
module  {
  func.func @kernel_trisolv(%arg0: i32, %arg1: memref<?x2000xf32>, %arg2: memref<?xf32>, %arg3: memref<?xf32>)  {
    affine.for %arg4 = 0 to 2000 {
      ...
      affine.for %arg5 = 0 to #map(%arg4) {
        ...
        %5 = affine.load %arg1[%arg4, %arg5] : memref<?x2000xf32>
      ...
      %2 = affine.load %arg1[%arg4, %arg4] : memref<?x2000xf32>
